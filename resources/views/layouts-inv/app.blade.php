        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    <li>
                        <a href="{{ route('store-warehouse') }}" class="text-success font-bold">คลังสินค้า {{ session('warehouse')['name'] }}</a>
                    </li>
                    <li>
...
<script>
    ...
    $('input[data-type=number]').number(true, 2)
</script>
@yield('script')
</body>
</html>
